...
rem #adb -s <your-device-id> shell su -c "setprop service.adb.tcp.port 5555 && stop adbd && start adbd"
rem #adb -s <your-device-id> shell setprop service.adb.tcp.port 5555
