...
wget https://nodejs.org/dist/v10.16.3/node-v10.16.3-linux-armv7l.tar.xz --no-check-certificate
tar -xpJf node-v10.16.3-linux-armv7l.tar.xz && rm -fr node-v10.16.3-linux-armv7l.tar.xz
...
wget https://nodejs.org/dist/v16.9.1/node-v16.9.1-linux-armv7l.tar.xz --no-check-certificate 
