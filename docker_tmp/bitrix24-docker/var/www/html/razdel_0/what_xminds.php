...
$APPLICATION->SetTitle("XmindS CRM");
?>
<style>
    .custom-container {
        max-width: 1200px;
...
<div class="custom-container">
	<div class="custom-loader">
		<h1 class="custom-title">Xmind CRM</h1>
		<p class="custom-subtitle">XmindS CRM</p>
		<div class="custom-header">
			<h1 class="custom-title"></h1>
			<p class="custom-subtitle"></p>
			<iframe src="https://xmind.ai/embed/WR4q092Q" width="900px" height="540px" frameborder="0" scrolling="yes" allow="fullscreen"></iframe>
		</div>
	</div>
</div>
