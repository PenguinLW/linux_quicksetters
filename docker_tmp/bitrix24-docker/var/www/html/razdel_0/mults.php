...
$APPLICATION->SetTitle("Mults CRM");
?>
<style>
    .custom-container {
        max-width: 1200px;
...
<div class="custom-container">
    <div class="custom-loader">
        <h1 class="custom-title">Mults CRM (обработка лида)</h1>
        <p class="custom-subtitle">Mults CRM (обработка лида)</p>
		<video controls style="width: 100%;">
			<source src="/razdel_0/BigBuckBunny.mp4" type="video/mp4">
        ...
        <h1 class="custom-title">Mults CRM (обработка сделки)</h1>
        <p class="custom-subtitle">Mults CRM (обработка сделки)</p>
		<video controls style="width: 100%;">
			<source src="/razdel_0/BigBuckBunny.mp4" type="video/mp4">
			Ваш браузер не поддерживает видео.
		</video>
